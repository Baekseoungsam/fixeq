...
<body>
    ...
    <header class="container-fluid masthead bg-primary text-white text-center">
      <div class="container">
        <img class="img-fluid mb-5 d-block mx-auto" src="img/infinity_war.jpg" alt="">
        <h1 class="text-uppercase mb-0">영화 한번 보실래요?</h1>
        <hr class="star-light">
